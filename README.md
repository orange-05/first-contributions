...
- Testing contributions workflow locally
- Potential upstream contributions (PRs should target upstream!)

**For the canonical, up-to-date guide, always visit the upstream repository.**
...
3. Make your first PR to *their* repository
